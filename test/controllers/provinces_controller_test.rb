...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { GST: @province.GST, HST: @province.HST, PST: @province.PST, name: @province.name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { GST: @province.GST, HST: @province.HST, PST: @province.PST, name: @province.name } }
